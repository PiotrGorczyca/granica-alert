						...
						>
							<div class="mb-2 flex items-start justify-between gap-3">
								...
								{#if isNewsType(event.type)}
									<div class="mb-2 flex items-center gap-2 rounded border border-amber-500 bg-amber-50 px-3 py-1.5 text-xs">
										<svg class="h-4 w-4 flex-shrink-0 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
