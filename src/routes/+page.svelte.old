...
<div class="min-h-screen bg-bg">
	<header class="border-b border-border bg-surface">
		<div class="mx-auto max-w-4xl px-4 py-4">
			<h1 class="text-2xl font-bold text-ink">Granica Alert</h1>
			<p class="mt-1 text-sm text-ink-muted">Świadomość sytuacyjna wschodniej Polski</p>
		</div>
	</header>
	...
	<main class="mx-auto max-w-4xl px-4 py-6">
		...
		<section class="mb-6">
			<a
				href="/map"
				class="block rounded-lg border-2 border-info bg-info-bg p-4 transition-all hover:border-calm hover:shadow-md"
			>
				<div class="flex items-center gap-3">
					...
					<div class="flex-1">
						<h3 class="font-semibold text-ink">Zobacz mapę interaktywną</h3>
						<p class="text-sm text-ink-muted">
							Strefa EP R134, przejścia graniczne i kontekst geograficzny
						</p>
					</div>
					<svg
